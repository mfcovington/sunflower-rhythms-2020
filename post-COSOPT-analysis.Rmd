...
plot.timecourse <- function(gene.list, east.color='orange', west.color='forestgreen',
                            ...
                            print.plot=TRUE, return.plot=FALSE, ncol=1) {
  library(ggplot2)
...
nrow(subset(cosopt, MeanExpLev.E >= min.meanexplev & MeanExpLev.W >= min.meanexplev))
#Expressed in East, West, and Merged: 26,641
nrow(subset(cosopt, MeanExpLev.E >= min.meanexplev & MeanExpLev.W >= min.meanexplev & MeanExpLev >= min.meanexplev))
#Expressed in East, West, or Merged: 33,488
nrow(subset(cosopt, MeanExpLev.E >= min.meanexplev | MeanExpLev.W >= min.meanexplev | MeanExpLev >= min.meanexplev))
...
Rhythmic Counts Summary:
    ...
    Total # of Expressed Genes:
        ...
        Merged: 30,844
        East, West, or Merged: 33,488
        East, West, and Merged: 26,641


    Rhythmic Genes in East or West time course: 25,607
    ...
    Rhythmic Genes in any time courses (East, West, and Merged): 26,486
    Rhythmic Genes in all three time courses (East, West, and Merged): 19,062


                              Rhythmic    Expressed    % Rhythmic
    East                        22,328       30,166         74.0%
    West                        22,374       29,950         74.7%
    East or West                25,607       33,188         77.2%
    East and West               19,095       26,928         70.9%
    Merged                      24,574       30,844         79.7%
    East, West, or Merged       26,486       33,488         79.1%
    East, West, and Merged      19,062       26,641         71.6%
...
timecourse.cosopt.summary$ExpressedEast[timecourse.cosopt.summary$GeneID %in% subset(cosopt, MeanExpLev.E >= min.meanexplev)$GeneID] <- 1
timecourse.cosopt.summary$ExpressedWest[timecourse.cosopt.summary$GeneID %in% subset(cosopt, MeanExpLev.W >= min.meanexplev)$GeneID] <- 1
timecourse.cosopt.summary$ExpressedBoth[timecourse.cosopt.summary$GeneID %in% subset(cosopt, MeanExpLev.E >= min.meanexplev & MeanExpLev.W >= min.meanexplev)$GeneID] <- 1
timecourse.cosopt.summary$ExpressedMerged[timecourse.cosopt.summary$GeneID %in% subset(cosopt, MeanExpLev >= min.meanexplev)$GeneID] <- 1
